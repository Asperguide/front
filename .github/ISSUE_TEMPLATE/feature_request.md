...
- [ ] * I have searched [existing features](https://github.com/Asperguide/front/issues?q=is%3Aissue+label%3Aenhancement) to ensure this feature has not been proposed.
- [ ] * I have read the [Code of Conduct](https://github.com/Asperguide/front/blob/main/CODE_OF_CONDUCT.md).
- [ ] * I have read the [commit conventions](https://github.com/Asperguide/front/blob/main/COMMIT_CONVENTION.md).
- [ ] * I have read the [contribution guidelines](https://github.com/Asperguide/front/blob/main/CONTRIBUTING.md).
